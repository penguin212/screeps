...
var autospawner = {
    run: function(spawner){
        ...
        var current_harvesters = _.sum(Game.creeps, (c) => c.memory.role == 'harvester' && c.memory.room == Game.spawns[spawner].room);
        var current_upgraders = _.sum(Game.creeps, (c) => c.memory.role == 'upgrader' && c.memory.room == Game.spawns[spawner].room);
