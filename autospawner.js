...
var autospawner = {
    run: function(spawner){
        ...
        var current_harvesters = _.sum(Game.creeps, (c) => c.memory.role == 'builder' && c.memory.room == Game.spawns[spawner].room);
        var current_upgraders = _.sum(Game.creeps, (c) => c.memory.role == 'builder' && c.memory.room == Game.spawns[spawner].room);
